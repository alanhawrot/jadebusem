...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JadeBusemUser.user_id'
        db.add_column(u'Users_jadebusemuser', 'user_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JadeBusemUser.user_id'
        db.delete_column(u'Users_jadebusemuser', 'user_id')
