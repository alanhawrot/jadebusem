...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Schedule.image_path'
        db.alter_column(u'schedules_schedule', 'image_path', self.gf('django.db.models.fields.FilePathField')(path='./static/schedule_images/', max_length=100, null=True))
    ...
    models = {
        ...
        u'schedules.schedule': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_path': ('django.db.models.fields.FilePathField', [], {'default': "''", 'path': "'./static/schedule_images/'", 'max_length': '100'}),
