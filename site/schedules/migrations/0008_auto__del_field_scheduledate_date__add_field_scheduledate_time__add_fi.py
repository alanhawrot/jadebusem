...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ScheduleDate.date'
        db.delete_column(u'schedules_scheduledate', 'date')

        # Adding field 'ScheduleDate.time'
        db.add_column(u'schedules_scheduledate', 'time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2013, 11, 14, 0, 0)),
                      keep_default=False)

        # Adding field 'ScheduleDate.day'
        db.add_column(u'schedules_scheduledate', 'day',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ScheduleDate.date'
        db.add_column(u'schedules_scheduledate', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 14, 0, 0)),
                      keep_default=False)

        # Deleting field 'ScheduleDate.time'
        db.delete_column(u'schedules_scheduledate', 'time')

        # Deleting field 'ScheduleDate.day'
        db.delete_column(u'schedules_scheduledate', 'day')
