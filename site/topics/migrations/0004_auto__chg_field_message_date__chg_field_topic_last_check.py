...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'topics_message', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Topic.last_check'
        db.alter_column(u'topics_topic', 'last_check', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Message.date'
        db.alter_column(u'topics_message', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Topic.last_check'
        db.alter_column(u'topics_topic', 'last_check', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'topics.topic': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'topics'", 'to': u"orm['Users.JadeBusemUser']"}),
