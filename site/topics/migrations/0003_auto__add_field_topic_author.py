...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'topics_topic', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='topics', to=orm['Users.JadeBusemUser']),
                      keep_default=False)
    ...
    models = {
        ...
        u'topics.topic': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_check': ('django.db.models.fields.DateField', [], {}),
